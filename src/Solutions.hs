...
solutions = Map.fromList [
   (  1, mkSol (p1, return 1000)),
   (  2, mkSol (p2, return 4000000)),
   (  3, mkSol (p3, return 600851475143)),
   (  4, mkSol (p4, return 3)),
   (  5, mkSol (p5, return 20)),
   (  6, mkSol (p6, return 100)),
   (  7, mkSol (p7, return 10001)),
   (  8, mkSol (p8, Str <$> readFile "inputs/p8.txt")),
   (  9, mkSol (p9, return 1000)),
   ( 10, mkSol (p10, return 2000000)),
   ( 11, mkSol (p11, Str <$> readFile "inputs/p11.txt")),
   ( 12, mkSol (p12, return 500)),
   ( 13, mkSol (p13, Str <$> readFile "inputs/p13.txt")),
   ( 14, mkSol (p14, return 1000000)),
   ( 15, mkSol (p15, return 20)),
   ( 16, mkSol (p16, return 1000)),
   ( 17, mkSol (p17, return 1000)),
   ( 18, mkSol (p18, Str <$> readFile "inputs/p18.txt")),
   ( 19, mkSol (p19, return 100)),
   ( 20, mkSol (p20, return 100)),
   ( 21, mkSol (p21, return 10000)),
   ( 22, mkSol (p22, Str <$> readFile "inputs/p22.txt")),
   ( 23, mkSol (p23, return 28123)),
   ( 24, mkSol (p24, return 1000000)),
   ( 25, mkSol (p25, return 1000)),
   ( 26, mkSol (p26, return 1000)),
   ( 27, mkSol (p27, return 1000)),
   ( 28, mkSol (p28, return 1001)),
   ( 29, mkSol (p29, return 100)),
   ( 30, mkSol (p30, return 5)),
   ( 31, mkSol (p31 [1, 2, 5, 10, 20, 50, 100, 200], return 200)),
   ( 32, mkSol (p32, return 10000)),
   ( 33, mkSol (p33, return ())),
   ( 34, mkSol (p34, return ())),
   ( 35, mkSol (p35, return 1000000)),
   ( 36, mkSol (p36, return 1000000)),
   ( 37, mkSol (p37, return ())),
   ( 38, mkSol (p38, return ())),
   ( 39, mkSol (p39, return 1000)),
   ( 40, mkSol (p40, return 6)),
   ( 41, mkSol (p41, return ())),
   ( 42, mkSol (p42, Str <$> readFile "inputs/p42.txt")),
   ( 43, mkSol (p43, return ())),
   ( 44, mkSol (p44, return ())),
   ( 45, mkSol (p45, return 286)),
   ( 46, mkSol (p46, return ())),
   ( 47, mkSol (p47, return 4)),
   ( 48, mkSol (p48, return 1000)),
   ( 49, mkSol (p49, return ())),
   ( 50, mkSol (p50, return 1000000)),
   ( 51, mkSol (p51, return 6)),
   ( 52, mkSol (p52, return 6)),
   ( 53, mkSol (p53, return 1000000)),
   ( 54, mkSol (p54, Str <$> readFile "inputs/p54.txt")),
   ( 55, mkSol (p55, return 9999)),
   ( 56, mkSol (p56, return 99)),
   ( 57, mkSol (p57, return 1000)),
   ( 58, mkSol (p58, return 10)),
   ( 59, mkSol (p59, Str <$> readFile "inputs/p59.txt")),
   ( 60, mkSol (p60, return 10000)),
   ( 61, mkSol (p61, return 9999)),
   ( 62, mkSol (p62, return ())),
   ( 63, mkSol (p63, return ())),
   ( 64, mkSol (p64, return 10000)),
   ( 65, mkSol (p65, return 100)),
   ( 66, mkSol (p66, return 1000)),
   ( 67, mkSol (p18, Str <$> readFile "inputs/p67.txt")),
   ( 68, mkSol (p68, return ())),
   ( 69, mkSol (p69, return 1000000)),
   ( 70, mkSol (p70, return 10000000)),
   ( 71, mkSol (p71, return 1000000)),
   ( 72, mkSol (p72, return 1000000)),
   ( 73, mkSol (p73, return 12000)),
   ( 74, mkSol (p74, return 999999)),
   ( 75, mkSol (p75, return 1500000)),
   ( 76, mkSol (p31 [1..99], return 100)),
   ( 77, mkSol (p77, return 5000)),
   ( 78, mkSol (p78, return 1000000)),
   ( 79, mkSol (p79, Str <$> readFile "inputs/p79.txt")),
   ( 80, mkSol (p80, return 100)),
   ( 81, mkSol (p81, Str <$> readFile "inputs/p81.txt")),
   ( 82, mkSol (p82, Str <$> readFile "inputs/p82.txt")),
   ( 83, mkSol (p83, Str <$> readFile "inputs/p83.txt")),
   ( 84, mkSol (p84, return 100000)),
   ( 85, mkSol (p85, return 2000000)),
   ( 86, mkSol (p86, return 1000000)),
   ( 87, mkSol (p87, return 50000000)),
   ( 88, mkSol (p88, return 12000)),
   ( 89, mkSol (p89, Str <$> readFile "inputs/p89.txt")),
   ( 90, mkSol (p90, return ()))]
